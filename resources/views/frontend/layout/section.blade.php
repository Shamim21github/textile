...
<div class="banner_slider_wrapper">
    <div class="banner_slider banner_slider_2">
        <div class="slide">
            <div class="slide_img"
                style="background-image: url({{ asset('frontend/images/slides/slider-mainbg-003.jpg') }} );"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div
                                ...
                                <p data-animation="fadeInDown">When select the best of your choice sucks, let our
                                    fabrics be an be an exception! </p>
                                <div class="d-inline-block margin_top40 res-767-margin_top30" data-animation="fadeInUp"
                                    data-delay="1.4">
                                    <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor"
                                        href="contact-us.html">DISCUSS A PROJECT</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="slide">
            <div class="slide_img"
                style="background-image: url({{ asset('frontend/images/slides/slider-mainbg-004.jpg') }} );"></div>
            <div class="slide__content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
...
<div class="site-main">
                            ...
                            <div class="featured-icon-box icon-align-top-content style3">
                                ...
                                <div class="featured-content">
                                    ...
                                    <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-skincolor"
                                        href="we-design-fabric.html">read more<i class="fa fa-long-arrow-right"></i></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <div class="featured-icon-box icon-align-top-content style3">
                                ...
                                <div class="featured-content">
                                    ...
                                    <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-skincolor"
                                        href="manufacturer.html">read more<i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div><!-- featured-icon-box end-->
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-8">
                    <div class="ttm_single_image-wrapper">
                        <img class="img-fluid auto_size" width="569" height="655"
                            src="{{ asset('frontend/images/single-img-03.png') }}" alt="single-03">
                    </div>
                </div>
                    ...
                    <div class="margin_top40">
                        ...
                        <div class="section-title">
                            ...
                            <div class="title-desc">
                                <p>Indian weavers of designer of furnishing fabrics is a textile manufacturer founded in
                                    1970 and renowned for new and stylish interpretations of natural & organic fabrics.
                                    All of our fabrics are designed and woven at our own weaving mill.</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul
                                    ...
                                    <li><i class="ti ti-check"></i><span class="ttm-list-li-content">Trends the Current
                                            Market</span></li>
                                    <li><i class="ti ti-check"></i><span class="ttm-list-li-content">The rayon fabrics
                                            wholesaler</span></li>
                                    <li><i class="ti ti-check"></i><span class="ttm-list-li-content">The Global
                                            fabrics distributor</span></li>
                                </ul>
                            </div>
                            <div class="col-sm-6">
                                <ul
                                    class="ttm-list ttm-bordered-lists ttm-list-style-icon ttm-list-icon-color-skincolor ttm-textcolor-darkgrey">
                                    <li><i class="ti ti-check"></i><span class="ttm-list-li-content">Biological tested
                                            fabrics</span></li>
                                    <li><i class="ti ti-check"></i><span class="ttm-list-li-content">Awarded For Best
                                            Exporter</span></li>
                                    <li><i class="ti ti-check"></i><span class="ttm-list-li-content">Stable partner
                                            global textile</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="margin_top35 res-767-margin_top20">
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor margin_right20 margin_top15"
                                href="about-us-2.html">view more</a>
            ...
            <div class="row no-gutters ttm-bgcolor-skincolor">
                ...
                <div class="col-lg-6">
                    ...
                    <img class="img-fluid ttm-equal-height-image w-100"
                        src="{{ asset('frontend/images/bg-image/col-bgimage-3.png') }}" alt="bg-image">
                </div>
            </div><!-- row end -->
        </div>
    </section>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style5">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>We do execute stabilization including reweaving & stitch repair details.
                                            </p>
                                        </div>
                                    </div>
                                </div><!-- featured-icon-box end-->
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box icon-align-top-content style5">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>Transfer dyes from aqueous solution onto the fiber surface & diffusion.
                                            </p>
                                        </div>
                                    </div>
                                </div><!-- featured-icon-box end-->
                        ...
                        <div class="col-lg-7">
                            <div
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>WELL DESIGNED</h3>
                                        <h2 class="title">We Provide Clothes <b>More Than Just Stitched Fabric</b>
                                        </h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>Textile is the largest peer-to-peer comparison initiative in the textile
                                            industry. It tracks the apparel material and home textile sector’s progress
                                            toward more sustainable materials sourcing, as well as alignment with global
                                            effort. Besides the regular production became the largest exporter.</p>
                                    </div>
                                </div><!-- section title end -->
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                        ...
                                        <div class="ttm-fid inside ttm-fid-with-icon ttm-fid-view-lefticon style2">
                                            ...
                                            <div class="ttm-fid-contents">
                                                <h4 class="ttm-fid-inner">
                                                    <span data-appear-animation="animateDigits" data-from="0"
                                                        data-to="800" data-interval="20" data-before=""
                                                        data-before-style="sup" data-after="+" data-after-style="sub"
                                                        class="numinate">800
                                                    </span>
                                                    <span>+</span>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div
                                ...
                                <div class="layer-content">
                                    ...
                                    <img class="img-fluid ttm-equal-height-image w-100"
                                        src="{{ asset('frontend/images/bg-image/col-bgimage-4.jpg') }}"
                                        alt="bg-image">
                                </div>
                            </div>
                        </div>
            ...
            <div class="row procedure-row position-relative mb_15">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure">
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198"
                                src="{{ asset('frontend/images/process-01-198x198.jpg') }}" alt="image">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure">
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198"
                                src="{{ asset('frontend/images/process-02-198x198.jpg') }}" alt="image">
                            <div class="process-num"></div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure">
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198"
                                src="{{ asset('frontend/images/process-03-198x198.jpg') }}" alt="image">
                            <div class="process-num"></div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="featured-imagebox featured-imagebox-procedure">
                        <div class="featured-thumbnail">
                            <img class="img-fluid auto_size" width="198" height="198"
                                src="{{ asset('frontend/images/process-04-198x198.jpg') }}" alt="image">
                            <div class="process-num"></div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
    ...
    <!--padding_zero-section-->
    <section
        class="ttm-row padding_zero-section col_overlay_section bg-layer-equal-height ttm-bgcolor-skincolor clearfix">
                    ...
                    <div class="ttm-bg ttm-col-bgcolor-yes ttm-bgcolor-darkgrey ttm-right-span spacing-4">
                        ...
                        <div class="layer-content">
                            ...
                            <div class="section-title">
                                ...
                                <div class="title-desc">
                                    <p>With production sites enhanced by tried and tested fabric collection. This means
                                        our clients get exactly what they want, very single time from wide range.</p>
                                </div>
                            </div><!-- section title end -->
                        </div>
                    </div>
                        ...
                        <div class="layer-content">
                            <div class="ml_160 res-1199-margin_left0">
                                <div class="row ttm-boxes-spacing-10px slick_slider slick-arrows-style3"
                                    data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "arrows":true, "autoplay":false, "infinite":true, "responsive": [{"breakpoint":1400,"settings":{"slidesToShow": 4}} , {"breakpoint":1204,"settings":{"slidesToShow": 3}}, {"breakpoint":777,"settings":{"slidesToShow": 2}},                {"breakpoint":575,"settings":{"slidesToShow": 1}}]}'>
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/images/portfolio/portfolio-01-600x700.jpg') }}"
                                                        alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Silk Fabric"
                                                        data-rel="prettyPhoto"
                                                        href="{{ asset('frontend/images/portfolio/portfolio-01-1200x800.jpg') }}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                                    <a href="silk-fabric.html" class="ttm_link"><i
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/images/portfolio/portfolio-02-600x700.jpg') }}"
                                                        alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Linen Fabric"
                                                        data-rel="prettyPhoto"
                                                        href="{{ asset('frontend/images/portfolio/portfolio-02-1200x800.jpg') }}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                                    <a href="linen-fabric.html" class="ttm_link"><i
                                                            class="fa fa-random"></i></a>
                                                </div>
                                            </div><!-- ttm-box-view-overlay end-->
                                            <div class="featured-content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/images/portfolio/portfolio-03-600x700.jpg') }}"
                                                        alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Wool Fabric"
                                                        data-rel="prettyPhoto"
                                                        href="{{ asset('frontend/images/portfolio/portfolio-03-1200x800.jpg') }}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                                    <a href="wool-fabric.html" class="ttm_link"><i
                                                            class="fa fa-random"></i></a>
                                                </div>
                                            </div><!-- ttm-box-view-overlay end-->
                                            <div class="featured-content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/images/portfolio/portfolio-04-600x700.jpg') }}"
                                                        alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Georgette Fabric"
                                                        data-rel="prettyPhoto"
                                                        href="{{ asset('frontend/images/portfolio/portfolio-04-1200x800.jpg') }}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                                    <a href="georgette-fabric.html" class="ttm_link"><i
                                                            class="fa fa-random"></i></a>
                                                </div>
                                            </div><!-- ttm-box-view-overlay end-->
                                            <div class="featured-content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/images/portfolio/portfolio-05-600x700.jpg') }}"
                                                        alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Leather Material"
                                                        data-rel="prettyPhoto"
                                                        href="{{ asset('frontend/images/portfolio/portfolio-05-1200x800.jpg') }}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                                    <a href="leather-material.html" class="ttm_link"><i
                                                            class="fa fa-random"></i></a>
                                                </div>
                                            </div><!-- ttm-box-view-overlay end-->
                                            <div class="featured-content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 ttm-box-col-wrapper">
                                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                                            ...
                                            <div class="ttm-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <img class="img-fluid"
                                                        src="{{ asset('frontend/images/portfolio/portfolio-06-600x700.jpg') }}"
                                                        alt="image">
                                                </div><!-- featured-thumbnail end-->
                                                <div class="ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Cotton Fabric"
                                                        data-rel="prettyPhoto"
                                                        href="{{ asset('frontend/images/portfolio/portfolio-06-1200x800.jpg') }}">
                                                        <i class="fa fa-search"></i>
                                                    </a>
                                                    <a href="cotton-fabric.html" class="ttm_link"><i
                                                            class="fa fa-random"></i></a>
                                                </div>
                                            </div><!-- ttm-box-view-overlay end-->
                                            <div class="featured-content">
            ...
            <div class="row">
                        ...
                        <div class="featuredbox-number mt_15">
                            ...
                            <div class="featured-icon-box icon-align-before-content style6">
                                ...
                                <div class="featured-content ttm-bgcolor-grey">
                                    ...
                                    <div class="featured-desc">
                                        <p>We own professional fabric trade department, which can save much more extra
                                            taxes.</p>
                                    </div>
                                </div>
                            </div><!-- featured-icon-box end-->
                            ...
                            <div class="featured-icon-box icon-align-before-content style6">
                                ...
                                <div class="featured-content ttm-bgcolor-grey">
                                    ...
                                    <div class="featured-desc">
                                        <p>We have more than 500 sets of world advanced machines for production process
                                        </p>
                                    </div>
                                </div>
                            </div><!-- featured-icon-box end-->
                            ...
                            <div class="featured-icon-box icon-align-before-content style6">
                                ...
                                <div class="featured-content ttm-bgcolor-grey">
                                    ...
                                    <div class="featured-desc">
                                        <p>We provide some additional services, like courier, social and educational!
                                        </p>
                                    </div>
                                </div>
                            </div><!-- featured-icon-box end-->
                ...
                <div class="col-xl-7 col-lg-8 col-md-12 mx-auto">
                    <div class="ttm_single_image-wrapper imagestyle-two text-lg-right">
                        ...
                        <img class="img-fluid auto_size" src="{{ asset('frontend/images/single-img-04.jpg') }}"
                            alt="single_04">
                    </div>
                </div>
            </div><!-- row end -->
            ...
            <div class="row slick_slider mb_15"
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{ asset('frontend/images/blog/blog-01-600x430.jpg') }}"
                                alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                            <div class="ttm-box-post-date">
                                ...
                                <time class="entry-date published" datetime="2021-03-18T04:16:25+00:00">March 18,
                                    2021</time>
                            </div><!-- ttm-box-post-date end -->
                            <div class="post-meta">
                                <span class="ttm-meta-line comments-link"><i class="fa fa-comments-o"></i>0
                                    Comments</span>
                            ...
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right"
                                href="blog-single.html">read more<i class="fa fa-long-arrow-right"></i></a>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{ asset('frontend/images/blog/blog-02-600x430.jpg') }}"
                                alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                            <div class="ttm-box-post-date">
                                <i class="fa fa-calendar"></i>
                                <time class="entry-date published" datetime="2021-02-28T04:15:42+00:00">February 28,
                                    2021</time>
                            </div>
                            <div class="post-meta">
                                <span class="ttm-meta-line comments-link"><i class="fa fa-comments-o"></i>0
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{ asset('frontend/images/blog/blog-03-600x430.jpg') }}"
                                alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                            <div class="ttm-box-post-date">
                                <i class="fa fa-calendar"></i>
                                <time class="entry-date published" datetime="2021-02-15T04:15:25+00:00">February 15,
                                    2021</time>
                            </div><!-- ttm-box-post-date end -->
                            <div class="post-meta">
                                <span class="ttm-meta-line comments-link"><i class="fa fa-comments-o"></i>0
                            ...
                            <div class="featured-desc">
                                <p>Enim nunc faucibus a pellentesque sit amet porttitor eget. Morbi blandit cursus
                                    risus...</p>
                            </div>
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right"
                                href="blog-single.html">read more<i class="fa fa-long-arrow-right"></i></a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" src="{{ asset('frontend/images/blog/blog-04-600x430.jpg') }}"
                                alt="blog-img">
                        </div>
                        <div class="featured-content">
                            <!-- ttm-box-post-date -->
                            <div class="ttm-box-post-date">
                                <i class="fa fa-calendar"></i>
                                <time class="entry-date published" datetime="2021-02-11T04:12:56+00:00">February 11,
                                    2021</time>
                            </div><!-- ttm-box-post-date end -->
                            <div class="post-meta">
                                <span class="ttm-meta-line comments-link"><i class="fa fa-comments-o"></i>0
                            ...
                            <div class="featured-desc">
                                <p>Viverra accumsan in nisl nisi. Et leo duis ut diam quam nulla porttitor massa.
                                    Pellen...</p>
                            </div>
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-color-dark btn-inline ttm-icon-btn-right"
                                href="blog-single.html">read more<i class="fa fa-long-arrow-right"></i></a>
