                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            <div class="ttm-featured-wrapper margin_bottom40">
                                <img class="img-fluid" src="{{ asset ('frontend/images/services/services-04-1200x800.jpg') }}" alt="services-04">
                            </div>
                            <div class="ttm-service-description">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <img class="img-fluid auto_size" width="494" height="560" src="{{ asset ('frontend/images/single-img-14.jpg') }}" alt="image"> 
                                    </div>
                                    <div class="col-md-8">
